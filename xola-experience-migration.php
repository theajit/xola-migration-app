      ...
      <form class="ui medium form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
        <div class="ui stacked segment">
          ...
          <div class="field">
           ...
           <div class="field">
          <div class="ui  input">
            <input type="password" name="d_password" placeholder="Seller Password(Destination Environment)" required>
          </div>
        </div>
          <div class="field">
          <div class="ui input">
        ...
        <div class="field">
          <div class="ui  input">
            <input type="password" name="d_admin_password" placeholder="Admin Password(Destination Environment)" required>
          </div>
        </div>
       
          <input type="submit" class="ui fluid large teal submit button" value="Start Experience Migration"></input>
        </div>
